...
void Filter::computePeakingCoeffs() {
    ...
    float sinw = sinf(w0);
    float cosw = cosf(w0);
    float a = powf(10, biquadFilterParams.g / 40.f);
    float alpha = 0.5f * sinw / (float) biquadFilterParams.q;
    
    float a0 = (1 + (alpha/a));
    biquadFilterParams.biquadCoeffs.a1.coefL = (-2.f * cosw) / a0;
    biquadFilterParams.biquadCoeffs.a1.coefR = biquadFilterParams.biquadCoeffs.a1.coefL;
    biquadFilterParams.biquadCoeffs.a2.coefL = (1.f - (alpha/a)) / a0;
    biquadFilterParams.biquadCoeffs.a2.coefR = biquadFilterParams.biquadCoeffs.a2.coefL;
    biquadFilterParams.biquadCoeffs.b0.coefL = (1.f + (alpha*a)) / a0;
    biquadFilterParams.biquadCoeffs.b0.coefR = biquadFilterParams.biquadCoeffs.b0.coefL;
    biquadFilterParams.biquadCoeffs.b1.coefL = (-2.f * cosw) / a0;
    biquadFilterParams.biquadCoeffs.b1.coefR= biquadFilterParams.biquadCoeffs.b1.coefL;
    biquadFilterParams.biquadCoeffs.b2.coefL = (1.f - (alpha*a)) / a0;
...
void Filter::computeLowPassCoeffs() {
    ...
    biquadFilterParams.biquadCoeffs.a1.coefL = (-2.f * cosw) / a0;
    biquadFilterParams.biquadCoeffs.a1.coefR = biquadFilterParams.biquadCoeffs.a1.coefL;
    biquadFilterParams.biquadCoeffs.a2.coefL = (1.f - (alpha)) / a0;
    biquadFilterParams.biquadCoeffs.a2.coefR = biquadFilterParams.biquadCoeffs.a2.coefL;
    biquadFilterParams.biquadCoeffs.b0.coefL = (1.f - cosw) / (2.f * a0);
    biquadFilterParams.biquadCoeffs.b0.coefR = biquadFilterParams.biquadCoeffs.b0.coefL;
    biquadFilterParams.biquadCoeffs.b1.coefL = (1.f - cosw) / a0;
    biquadFilterParams.biquadCoeffs.b1.coefR= biquadFilterParams.biquadCoeffs.b1.coefL;
    biquadFilterParams.biquadCoeffs.b2.coefL = (1.f - cosw) / (2.f * a0);
    biquadFilterParams.biquadCoeffs.b2.coefR = biquadFilterParams.biquadCoeffs.b2.coefL;
}
